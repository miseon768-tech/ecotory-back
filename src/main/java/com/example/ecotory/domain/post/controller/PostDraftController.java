...
public class PostDraftController {
    ...
    @PostMapping
    public ResponseEntity<SaveDraftResponse> saveDraft(@RequestAttribute Member member,
                                       @RequestParam String title,
                                       @RequestParam String content) {

        SaveDraftResponse response = postDraftService.saveDraft(member, title, content);
    ...
    public ResponseEntity<GetDraftResponse> getDrafts(@RequestAttribute Member member) {
        ...
        GetDraftResponse response = postDraftService.getDraft(member);
